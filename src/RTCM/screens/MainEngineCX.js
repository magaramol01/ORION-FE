...
import {addVesselDetailsToSession, getMainEngineScreenData} from "../../api";
import HederUI from "../common/HederUI";

class MainEngineHome extends Component {
    ...
    fetchMainEngineScreenState() {
        getMainEngineScreenData(getVesselId(), this.onFetchDataSuccess, function () {});
    }

    onFetchDataSuccess(response) {
        if (response && response.data) {
            const mainEngineStateJson = response.data.mainEngineStateJson;
    ...
    render() {
        ...
        return (
            <SMSidebar history={this.props.history} screenPath={"/MainEngineHome"}>
...

                                            {
                                                this.state.mainEngineState ?
                                                    <DashboardGridLayout
                                                        ...
                                                        socketSubscriberName={"subscribeToMainEngine"}
