                ...
                <div style={{position: "absolute"}}>
                    <table id="singleCylinderWidgetId" className="single-cylinder-table" style={{width:"260px"}}>
                        ...
                        <tr>
                            <td className="single-cylinder-blank-panel-caption">
                                <div
                                    className="single-cylinder-table-data-normal"> {headerData.value5.widgetData.caption} </div>
                            </td>
                        </tr>
                        <tr>
                            <td className="single-cylinder-blank-panel-caption">
                        ...
                        <tr>
                            <td className="single-cylinder-blank-panel-caption">
                                <div
                                    className="single-cylinder-table-data-normal"> {headerData.value7.widgetData.caption} </div>
                            </td>
                        </tr>
                        <tr>
                            <td className="single-cylinder-blank-panel-caption">
                        ...
                        <tr>
                            <td className="single-cylinder-blank-panel-caption">
                                <div
                                    className="single-cylinder-table-data-normal"> {headerData.value9.widgetData.caption} </div>
                            </td>
                        </tr>
    ...
    getCylinderPropellerRenderer = (propellerData, tableData) => {
        ...
        return (
            <div style={{display: "flex", marginLeft: '-14px'}}>
                ...
                <div style={{position: 'absolute', marginTop: '330px', marginLeft: '310px',color: 'white'}}>
                    <Image src={cropped} style={{height: '60px', width: '60px'}}/>
                </div>

                <div style={{width: '200px', marginLeft: '-200px', marginTop: '320px', textAlign: "center",color: 'white'}}>
                ...
                <div style={{width: '200px', marginLeft: '-260px', marginTop: '390px', textAlign: "center",color: 'white'}}>
                ...
                <div style={{width: '200px', marginLeft: '-60px', marginTop: '390px', textAlign: "center",color: 'white'}}>
                ...
                <div style={{width: '105px', marginLeft: '-35px', marginTop: '300px',color: 'white'}}>
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className={thirdRow}><span
                                    className="cw_outlet_temp_1"> {tableData ? tableData.value3.widgetData.value : defaultValue} </span> {tableData.value1.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className={fifthRow}><span
                                    className="cyl_linear_wall1"> {tableData ? tableData.value5.widgetData.value : defaultValue} </span> {tableData.value1.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className={seventhRow}><span
                                    className="scav_air_temp1"> {tableData ? tableData.value7.widgetData.value : defaultValue} </span> {tableData.value1.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className={ninthRow}><span
                                    className="pco_outlet_flow1"> {tableData ? tableData.value9.widgetData.value : defaultValue} </span> {tableData.value1.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        {this.blankRow({trStyle: {height: '22px'}, tdStyle: {}})}
