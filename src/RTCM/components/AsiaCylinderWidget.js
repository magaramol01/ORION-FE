...
class AsiaCylinderWidget extends React.Component {
            ...
            <div style={{display: "flex", marginLeft: 0, marginRight: '160px'}}>
                ...
                <div style={{position: "absolute"}}>
                    <table id="singleCylinderWidgetId" className="single-cylinder-table" style={{width:"260px"}}>
                        ...
                        {/*        <div*/}
                        {/*            className="single-cylinder-table-data-normal"> {headerData.value1.widgetData.caption}{' '}{headerData.value1.widgetData.value} </div>*/}
                        {/*    </td>*/}
                        {/*</tr>*/}
                        {this.blankRow({trStyle: {}, tdStyle: {height: '20px'}})}
                        {/*<tr>*/}
                        {/*    <td className="single-cylinder-blank-panel-caption">*/}
                        {/*        <div*/}
                        {/*            className="single-cylinder-table-data-normal"> {headerData.value2.widgetData.caption}{' '}{headerData.value2.widgetData.value} </div>*/}
                        {/*    </td>*/}
                        {/*</tr>*/}
                        {this.blankRow({trStyle: {}, tdStyle: {height: '20px'}})}
    ...
    getCylinderPropellerRenderer = (propellerData, tableData) => {
        ...
        return (
            <div style={{display: "flex", marginLeft: '-14px'}}>
                ...
                <div style={{position: 'absolute', marginTop: '180px', marginLeft: '140px'}}>
                    {/*<div style={{height: "30px",width:"200px"}}>*/}
                    {/*    <div><span className="captionUnitColor">{value1Caption}</span>{"  "}<span*/}
                    {/*        className="valueFont">{value1Value}</span></div>*/}
                    {/*</div>*/}
                    {/*<div style={{height: "30px"}}>*/}
                    {/*    <div><span className="captionUnitColor">{value2Caption}</span>{"  "}<span*/}
                    {/*        className="valueFont">{value2Value}</span></div>*/}
                    {/*</div>*/}
                </div>
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className={fifthRow}><span
                                    className="cyl_linear_wall1"> {tableData ? tableData.value2.widgetData.value : defaultValue} </span> {tableData.value2.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        {/*<tr>*/}
                        ...
                        <tr>
                            <td className="single-cylinder-table-data">
                                <div className="single-cylinder-table-data-normal"><span
                                    className="crosshead_bear_temp_aft1"> {tableData ? tableData.value5.widgetData.value : defaultValue} </span> {tableData.value1.widgetData.unit}
                                </div>
                            </td>
                        </tr>
                        {this.blankRow({trStyle: {}, tdStyle: {}})}
...
export default AsiaCylinderWidget;