...
import FleetKPIModal from "./FleetKPIModal";
import CIIReductionModal from "./CIIReductionModal";
...
class CIIFilter extends PureComponent {
  static contextType = AppContext;

  extractLatestVoyageLabel = (valArr, context) => {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      ciiType: "demand",
      isShowFleetModal: false,
      isShowCIIReductionModal: false,
    };
  ...
  filterCIIData = () => {
    ...
    const currentFilter = this.state.activeFilterType;
    if (currentFilter === "byVoyage") {
      this.state.dashboardRef.fetchCIIStateByVoyage(
        this.state.forQueryDefaultVoaygeLabel,
        state.ciiType
      );
    } else {
      this.state.dashboardRef.fetchCIIStateByDate(
        this.state.fromDate,
        this.state.toDate,
        this.state.ciiType
      );
  ...
  componentDidUpdate = (prevProps, prevState) => {
    ...
    if (this.state.defaultVoyageLabel !== prevState.defaultVoyageValue) {
      ...
      // this.state.
      // this.state.dashboardRef.fetchCIIStateByVoyage(forQuery, state.ciiType);
      this.state.dashboardRef.fetchCIIStateByVoyage(forQuery, state.ciiType);
  ...
  onVoyageSelection = (event, list) => {
    ...
    if (voyageName === "All") {
      ...
      this.state.dashboardRef.fetchCIIStateByDateAndVoyage(
        voyageName,
        this.state.fromDate,
        this.state.toDate
      );
  ...
  handleCIITypeChange = (e) => {
    const { dispatch, state } = this.context;
    const ciiType = e.target.name;
    this.setState({ ciiType });
    if (ciiType === "demand") {
      dispatch({
        type: "SET_CII_TYPE",
        payload: "demand",
  ...
  hideModal = () => {
    this.setState({ isShowFleetModal: false });
  };
  ...
  render() {
    ...
    return (
      <>
        <div className="row">
          {isVoyageFilterApplied ? (
            <div className="col-lg-7" style={{ textAlign: "right" }}>
              ...
              >
                <div className="container-fluid d-flex pl-2 pr-2 pt-1 pb-1 text-light">
              ...
              >
                ...
                <div className="container-fluid pl-2 pr-2 d-flex">
                  {isVoyageFilterApplied ? (
                    ...
                    <Fragment>
                      <Form.Group size="sm" className="d-flex pr-2 text-light">
          ...
          {isVoyageFilterApplied ? (
              ...
              {isVoyageFilterApplied ? (
                <div className="row">
                  <div className="col-lg-4">
                    <div className="col-lg-11">Select CII Type</div>
                    <div className="col-lg-11">
                      <input
                        ...
                        data-key="demand"
                        onChange={this.handleCIITypeChange}
                        autocomplete="off"
                      />

                      <label
                        className={`btn mt4 btnTypeVovage ${
                          this.state.ciiType === "demand" &&
                          "btnTypeVovageSelected"
                        }`}
                        for="btn-demand"
                      >
                  ...
                  <div className="col-lg-1">
                    {/* <Button className="d-flex align-items-center p-0 mr-1 btn-sm">
                      Fleet KPI
                    </Button> */}
                    <Button
                      className="d-flex align-items-center mr-2 btn-sm"
                      style={{ background: "#00527E", marginTop:"25px" }}
                      onClick={() =>
                        this.setState({ isShowCIIReductionModal: true })
                      }
                    >
                      <i className="fa fa-info-circle"></i>
                    </Button>
                    {/* <Button
                      className="d-flex align-items-center mt-1 mr-2 btn-sm"
                      style={{ background: "#00527E" }}
                      onClick={() => this.setState({ isShowFleetModal: true })}
                    >
                      Fleet KPI's
                    </Button> */}
                  </div>
            ...
            <div className="col-lg-8" style={{ color: "#33b5e5" }}>
              <div className="row ml-2">
                ...
                <div className="col-lg-3">
                  <div className="row">
                    <div className="col-lg-11 ml-3">Select voyage Type</div>
        ...
        {/* <FleetKPIModal
          isShow={this.state.isShowFleetModal}
          onHide={() => this.setState({ isShowFleetModal: false })}
        /> */}
        <CIIReductionModal
          isShow={this.state.isShowCIIReductionModal}
          onHide={() => this.setState({ isShowCIIReductionModal: false })}
        />
      </>
    );
  }
