...
class SparIndusCylinderWidget extends React.Component {
            ...
            <div style={{display: "flex", marginLeft: 0, marginRight: '160px'}}>
                ...
                <div style={{position: "absolute"}}>
                    <table id="singleCylinderWidgetId" className="single-cylinder-table" style={{width:"260px"}}>
                        ...
                        {/*        <div*/}
                        {/*            className="single-cylinder-table-data-normal"> {headerDatafirstThree.value1.widgetData.caption} </div>*/}
                        {/*    </td>*/}
                        {/*</tr>*/}
                        {this.blankRow({trStyle: {}, tdStyle: {height: '20px'}})}
                        {/*<tr>*/}
...
export default SparIndusCylinderWidget;
