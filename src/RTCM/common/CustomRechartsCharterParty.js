    ...
    if (active && payload) {
        ...
        return (
            <div className="rechart-custom-tooltip">
                ...
                <div>Value2 : {tooltipData1.value} {rechartGaugeData.widgetData.unit}</div>
                {/*<div>Lower Threshold : {rechartGaugeData.lowerBoundValue} B0C</div>*/}
                {/*<div>Upper Threshold : {rechartGaugeData.upperBoundValue} B0C</div>*/}
            </div>
        );
    }
...
class CustomRechartsCharterParty extends Component {
    ...
    onGaugeSelectionChange(rechartModbusParameterIdentifier) {
        this.setState({
            ...
            return (
                <div style={{height: '155px'}}>
                    <div style={{position: "absolute", width: "100%"}}>
                        <div style={{display: "flex", justifyContent: "space-between", fontSize: fontSize, marginTop: '115px', paddingRight: "26px"}}>
                    ...
                    <ResponsiveContainer height='100%' width='93%'>
                        <LineChart width={880} height={100} margin={{top: 0, right: 0, left: 15, bottom: 15}} data={rechartData}>
                            ...
                            <ReferenceArea
                                y1={rechartGaugeData.lowerBoundValue}
                                y2={rechartGaugeData.upperBoundValue}
                                stroke="none"
                                fill="#578fc3"
                                opacity={0.2}
                            />
                            ...
                            <YAxis
                                axisLine={true}
                                tickLine={true}
                                domain={[rechartGaugeData.minValue, rechartGaugeData.maxValue]}
                                stroke="#d8d9da"
...
export default CustomRechartsCharterParty;